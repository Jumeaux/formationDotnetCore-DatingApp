    ...
    public class MessageRepository : IMessageRepository
    {
        ...
        public async Task<PagedList<MessageDto>> GetMessageForUser(MessageParams messageParams)
        {
            ...
            query = messageParams.Container switch
            {
                ...
                "Oubox"=> query.Where(u =>u.Sender.UserName == messageParams.Username && u.SenderDelete==false),
                _=> query.Where(u =>u.Recipient.UserName == messageParams.Username && u.DateRead== null && u.RecipientDelete==false)
            };
        ...
        public async Task<IEnumerable<MessageDto>> GetMessageThread(string currentUserUsername, string recipientUsername)
        {
            var messages= await _context.Messages
                    ...
                    var unreadMessages = messages.Where(m => m.DateRead==null && m.Recipient.UserName == currentUserUsername);
